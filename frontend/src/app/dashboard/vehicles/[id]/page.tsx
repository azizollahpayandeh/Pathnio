...
const GaugeIcon = () => (
  <svg
    ...
    className="inline-block mr-2 rtl:ml-2 rtl:mr-0" // RTL adjustment
  >
    <path
    ...
    <div className="bg-slate-50 min-h-screen px-4 py-8 sm:px-6 lg:px-8 font-[Inter,sans-serif] text-gray-800 flex justify-center">
      ...
      <div className="w-full max-w-7xl mx-auto">
        ...
        <button
          ...
          // changed mb-6 to mb-12 for more space
          className="flex items-center gap-2 bg-white/90 hover:bg-white text-blue-700 font-semibold px-6 py-3 rounded-xl shadow-lg border border-blue-200 hover:shadow-xl transition-all duration-300 backdrop-blur-sm hover:scale-105 mb-12" 
        >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 grid-flow-row auto-rows-fr">
          {/* Left Column */}
          ...
          <div className="lg:col-span-1 flex flex-col h-full justify-between space-y-6">
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-lg shadow-indigo-200/50">
              ...
              <div className="text-center text-gray-700 mt-4">
                <p className="text-lg font-semibold">
                  Route:{' '}
                  <span className="text-blue-600">Mashhad to Tehran</span>
                </p>
