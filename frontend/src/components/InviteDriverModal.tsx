      ...
      <div className="w-full max-w-md bg-white rounded-3xl shadow-xl p-6 animate-fade-in">
        <div className="flex items-start justify-between mb-1">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="font-bold text-slate-900 leading-tight">Driver activation</h3>
        ...
        <p className="text-sm text-slate-500 mt-3">
          Share this one-time code with <span className="font-semibold">{driverName}</span>.
          ...
          <div className="mt-4">
            {info?.status === "USED" ? (
              ...
              <div className="rounded-xl bg-slate-50 border border-slate-100 px-4 py-3 text-slate-500 text-sm">
                No active invitation. Generate a code to invite this driver.
              </div>
            )}
          </div>
        )}
