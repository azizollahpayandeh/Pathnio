      ...
      <form onSubmit={submit} className="space-y-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <Field label="Full Name" required>
            <input className="field" required value={form.full_name} onChange={(e) => set("full_name", e.target.value)} placeholder="e.g. Arsalan Ahmadi" />
          </Field>
          ...
          <Field label="License No.">
            <input className="field" value={form.license_no} onChange={(e) => set("license_no", e.target.value)} placeholder="e.g. DL-100000" />
          </Field>
          ...
          <Field label="Assigned Plate">
            <input className="field" value={form.plate_number} onChange={(e) => set("plate_number", e.target.value)} placeholder="e.g. 21-B-984" />
          </Field>
        </div>
